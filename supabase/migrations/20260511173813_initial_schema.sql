...
CREATE TABLE public.subjects(
    subject_number TEXT NOT NULL PRIMARY KEY,
...
CREATE TABLE public.categories(
    category_number TEXT NOT NULL PRIMARY KEY,
    subject_number TEXT NOT NULL REFERENCES public.subjects(subject_number),
    display_title TEXT NOT NULL,
    description TEXT
);
...
CREATE TABLE public.playgrounds(
    playground_number TEXT NOT NULL PRIMARY KEY,
    category_number TEXT NOT NULL REFERENCES public.categories(category_number),
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
